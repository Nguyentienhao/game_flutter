...
class BoardState extends State<Board> {
        ...
        bottom: PreferredSize(
          ...
          child: Row(children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: wonGame ? " \t You've Won! $timeElapsed second"
                      : alive ? "\t \t Mines found: $minesFound \n \t \t Total Mines: $numOfMines \n \t \t $timeElapsed second"
  ...
  int bombs(int x, int y) => isBoard(x, y) && tiles[y][x] ? 1: 0;
  bool isBoard(int x, int y) => x >= 0 && x < cols && y >= 0 && y < rows;
}
